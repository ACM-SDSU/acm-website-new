    ...
    return (
        <section id="contact"  class="pt-16">
            ...
            <div class="flex flex-row space-x-4 p-4 justify-center text-2xl text-center">
                ...
                <div class="p-4 w-1/5">
                    <a href="https://www.instagram.com/sdsu_acm/" target="_blank" class="flex items-center justify-center space-x-2">
                ...
                <div class="p-4 w-1/5">
                    <a href="mailto:aztecs.acm@gmail.com" target="_blank" class="flex items-center justify-center space-x-2">
