        ...
        <section id="overview" class="h-screen bg-cover bg-center" style={{backgroundImage: `url(${imageUrl})`}}>
            <div class="bg-black bg-opacity-50 w-full h-full flex flex-col justify-center items-center">
                ...
                <div class="flex flex-row space-x-4 p-4 justify-center">
                    <div class="text-gray-200 bg-gray-600 bg-opacity-90 p-4 rounded-xl flex flex-col items-center justify-start w-1/4">
                    ...
                    <div class="text-gray-200 bg-gray-600 bg-opacity-90 p-4 rounded-xl flex flex-col items-center justify-start w-1/4">
                        ...
                        <div class="mb-3 mt-3">
                            <a href="https://discord.gg/UuNuggpKYV" target="_blank" class="flex items-center justify-center space-x-2 text-2xl hover:text-acm-blue">
